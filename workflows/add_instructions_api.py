"""
# Script name: add_instructions_api.py
...
USAGE
python3 add_instructions_api.py [-h] api_key dataset_id dataset_name 
...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("dataset_id", help="ID of the dataset to add instructions to")
    parser.add_argument(
        "dataset_name", help="Name of the dataset to add instructions to"
    )
