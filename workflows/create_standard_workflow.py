"""
# Script name: create_standard_workflow.py
...
USAGE
python3 create_standard_workflow.py [-h] api_key team_slug 
...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("team_slug", help="slugified version of the team name")
...
def main() -> None:
    ...
    payload = {
        ...
        "stages": [
            {
                "config": {"initial": True, "dataset_id": None, "x": 2942, "y": 2896},
                "edges": [
                    {
                        "id": dataset_edge_id,
