...
USAGE
python3 register_single_ro_file.py [-h] api_key team_slug dataset_slug storage_name storage_key file_name storage_thumbnail_key
...
storage_thumbnail_key: Path to thumbnail file in your external storage
...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help='Path to thumbnail file in your external storage'
    )
...
def main():
    ''' main()
        Registers a single file from external storage in a read-only configuration with a Darwin dataset.
                ...
                "slots": [
                    {
                        ...
                        "storage_thumbnail_key": args.storage_thumbnail_key,
                        "width": width,
                        "height": height,
    ...
    response = requests.post(
        f"https://darwin.v7labs.com/api/v2/teams/{args.team_slug}/items/register_existing_readonly",
        headers=headers,
        json=payload
    )
