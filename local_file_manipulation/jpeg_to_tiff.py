...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("dataset_slug", help="slugified version of the dataset name")
    parser.add_argument("source_folder_path", help="path to files for conversion")
    parser.add_argument("target_folder_path", help="path to destination folder")
...
def upload_to_dataset(ApiKey, dataset_slug, target_folder_path):
    ...
    dataset.push(files_to_upload=local_files)
    print("Done!")
